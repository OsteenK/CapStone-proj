        ...
        <section className="causes-section">
          ...
          <div className="causes-cards">
            <div className="causes-card">
              <h4 className ="causes-title">PadUp 4 North Eastern</h4>
              <p className ="causes-text">This charity aims to provide 2000 girls living in the North Eastern region with sufficient sanitary towels to participate in the school year....</p>
              <button className="causes-button">Donate Now</button>
            </div>
            </div>
            <div className="causes-cards">
            <div className="causes-card">
              <h4 className ="causes-title">Water to Schools</h4>
              <p className ="causes-text">Our charity is working to provide a reliable source of clean water to a school in an underdeveloped region, so students can focus.......</p>
              <button className="causes-button">Donate Now</button>
              </div>
            </div>
            <div className="causes-cards">
            <div className="causes-card">
              <h4 className ="causes-title">Elevating Sanitary Facilities</h4>
              <p className ="causes-text">Our charity is dedicated to improving the health and well-being of communities by implementing UNICEF guidelines to provide safe...</p>
              <button className="causes-button">Donate Now</button>
            </div>
          </div>
        </section>
